...
export class AddTaskFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.validateForm = this.fb.group({
      ...
      titulo: [
        this.eventToEdit ? this.eventToEdit.titulo : null,
        [Validators.required],
      ],
      fechaInicioFin: [
        this.eventToEdit
          ? [this.eventToEdit.fechaInicio, this.eventToEdit.fechaFin]
          : null,
        [Validators.required],
      ],
      idTipoEvento: [
        this.eventToEdit ? this.eventToEdit.tipoEvento.id : null,
        [Validators.required],
      ],
      descripcion: [
        this.eventToEdit ? this.eventToEdit.descripcion : null,
        [Validators.required],
      ],
    });
    if (this.eventToEdit) {
