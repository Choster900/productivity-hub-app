          ...
          >
            ...
            <ng-template #tituloTarea>
              <div class=" flex gap-3 items-center">
                ...
                <span class="line-through">{{ item.titulo }}</span>
              </div>
            </ng-template>
            ...
            <div *ngIf="item.subtareas && item.subtareas.length > 0">
              ...
              >
                ...
                >
                <label class="dark:text-white/[.87]" nz-checkbox [(ngModel)]="subItem.estado" (change)="onClickInCheckBox(item, i)"></label>
    {{subItem.estado}}
                  <input
...
export class NzModalTareasComponent implements OnInit {
    ...
    onClickInCheckBox(tarea: TareasEvento, index: number): void {
        ...
        const allTrue = tarea.subtareas.every(subtarea => subtarea.estado === true);
        const allFalse = tarea.subtareas.every(subtarea => subtarea.estado === false);
        const someTrue = tarea.subtareas.some(subtarea => subtarea.estado === true);
